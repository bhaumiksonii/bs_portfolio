<template>
  <div class="bizScene">
    <TitleSection scene="bizTitle">
      <TitleFunction params="2021,*">Sqaudron Technology</TitleFunction>
    </TitleSection>

    <SceneSection id="biz1">
      <TextBlock>
        <p class="-big">
          From 2021 to current I am
          <strong class="-purple">Cloud Data enginner and Devops Engineer</strong>
          @
          <a
            href="https://www.squadrontechnology.com/"
            target="_blank"
            title="Visit Biz Commerce's website"
          >
            squadrontechnology</a
          >.
        </p>
        <p>
          A Cloud, Data and Analytics company recognised under
          Startup India - Initiative by Government of India.
          In the present digital and technology-oriented world
          the organizations are facing challenges to solve the
          data issues in the organizations..
        </p>
      </TextBlock>
      <template #container>
      ...
      <TextBlock>
        <p>
          ...
          <span class="-big -purple">
            tools, cloud migrations, integrations, and custom projects
          </span>
          for PDMI and random clients.
        </p>
      </TextBlock>
    </SceneSection>
    <SceneSection id="biz3">
      <TextBlock>
        <p>
          Squadron Technology is currently collaborating with PDMI
          <span class="-big">
            <span class="-purple">jointly spearheading various modules</span> such as 340b and managing drug claims
            integrations
            <span class="-purple">overseeing thousands of transactions</span> daily.
          </span>
        </p>
      </TextBlock>
    </SceneSection>
