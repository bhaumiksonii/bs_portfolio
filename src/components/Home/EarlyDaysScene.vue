  ...
  <div class="earlyDays">
    ...
    <SceneSection id="early-days">
      <TextBlock>
        ...
        <p class="-big">
          Co-Founder<br />
          <span class="-purple">Empowering home bakers, our platform serves as the go-to destination and
            providing a seamless marketplace for their delectable creations. </span>
        </p>
      </TextBlock>
    </SceneSection>
